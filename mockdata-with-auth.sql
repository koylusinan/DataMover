-- =============================================================================
-- MOCK DATA WITH AUTH USERS - Complete Setup
-- =============================================================================
...
(
  '93748edf-fe49-4cdb-a089-60ffb211d0d2',
...
(
  '317832e3-cb75-46f1-a0e7-c2b94c0418d5',
  '00000000-0000-0000-0000-000000000000',
  'sinan.koylu@gmail.com',
  crypt('password123', gen_salt('bf')),
  NOW(),
  NOW(),
  NOW(),
...
(
  '93748edf-fe49-4cdb-a089-60ffb211d0d2',
  '93748edf-fe49-4cdb-a089-60ffb211d0d2',
  '{"sub":"93748edf-fe49-4cdb-a089-60ffb211d0d2","email":"admin@example.com"}',
  'email',
  NOW(),
  NOW(),
  NOW()
...
(
  '317832e3-cb75-46f1-a0e7-c2b94c0418d5',
  '317832e3-cb75-46f1-a0e7-c2b94c0418d5',
  '{"sub":"317832e3-cb75-46f1-a0e7-c2b94c0418d5","email":"sinan.koylu@gmail.com"}',
  'email',
  NOW(),
  NOW(),
  NOW()
...
(
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000001',
  '{"sub":"00000000-0000-0000-0000-000000000001","email":"viewer@example.com"}',
  'email',
  NOW(),
  NOW(),
  NOW()
...
'{"tasks.max": "1", "topic.prefix": "oracle_cdc"}',
...
SELECT 'Users created:' as info, email, role
FROM user_profiles
ORDER BY role;
